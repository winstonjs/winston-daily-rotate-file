...
var DailyRotateFile = module.exports = function (options) {
  ...
  this.needToRotate = function() {
    var now = new Date();
    var self = this;
    var ret = false;
    this.datePattern.replace(token, function ($0) {
      if($0==='yy' || $0==='yyyy'){
...
DailyRotateFile.prototype.open = function (callback) {
  var self = this;
  var needToRotate = self.needToRotate();
  ...
  else if (!this._stream || (this.maxsize && this._size >= this.maxsize) || needToRotate) {
